...
Project 3 contains three python files: connection.py, interface.py,
 and project3.py is the default interface given for establishing 
...
project3.py is the driver class which contains
...
clean button is pressed the robot will stop. The wall following implements a PD controller
that keeps the robot following the wall around a 'setpoint' value. The gains can be adjusted
as constants at the top of project3.py